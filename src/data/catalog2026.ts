...
const QDEFS: QDef[] = [
  ...
  { id: "visitationszoner", kind: "dynamic", dimension: "galtan", polarity: 1, topic: "brottslighet", text: "Polisen bör kunna inrätta visitationszoner i områden med hög brottslighet.", rationale: "Omdebatterat verktyg." },
  ...
  { id: "integritet", kind: "structural", dimension: "galtan", polarity: -1, topic: "integritet", text: "Polisens möjligheter till kameraövervakning och avlyssning bör begränsas för att skydda den personliga integriteten.", rationale: "Integritet vs övervakning." },
  ...
  { id: "reduktionsplikt", kind: "dynamic", polarity: 1, topic: "drivmedel", text: "Reduktionsplikten för bensin och diesel bör sänkas.", rationale: "Klimat vs pris." },
  ...
  { id: "forsvarsanslag", kind: "dynamic", polarity: 1, topic: "försvar", text: "Försvarsanslagen bör höjas till minst 3 procent av BNP.", rationale: "Försvarsekonomi." },
